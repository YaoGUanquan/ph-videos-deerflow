...
export const zhCN: Translations = {
  ...
  settings: {
    ...
    phVideos: {
      title: "视频生成",
      description: "配置 ph-videos 视频生成所需的 API Key 和路径。",
      volcanoApiKey: "火山引擎/豆包 API Key",
      volcanoPlaceholder: "VOLCANO_API_KEY 或 ARK_API_KEY",
      dashscopeApiKey: "通义万相 API Key",
      dashscopePlaceholder: "DASHSCOPE_API_KEY",
      phVideosTextPath: "ph-videos-text 路径（可选）",
      phVideosTextPathPlaceholder: "用于复用 video clients 与 ffmpeg",
      defaultProvider: "默认视频提供商",
      storageHint:
        "配置仅保存在浏览器本地（localStorage），不发送到服务器，与 ph-videos-text 一致。",
      save: "保存",
      saved: "已保存",
    },
    notification: {
