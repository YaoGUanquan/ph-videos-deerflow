...
import { PhVideosSettingsPage } from "@/components/workspace/settings/ph-videos-settings-page";
...
export function SettingsDialog(props: SettingsDialogProps) {
  ...
  const sections = useMemo(
    () => [
      ...
      { id: "phVideos", label: t.settings.sections.phVideos, icon: FilmIcon },
        ...
        <div className="grid min-h-0 flex-1 gap-4 md:grid-cols-[220px_1fr]">
          ...
          <ScrollArea className="h-full min-h-0 rounded-lg border">
            <div className="space-y-8 p-6">
              ...
              {activeSection === "phVideos" && <PhVideosSettingsPage />}
